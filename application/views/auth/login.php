                        ...
                        <div class="container">
                            <form action="<?= site_url('auth/login') ?>" method="post">
                                ...
                                <div class="input-field  col s12">
                                    ...
                                    <input required placeholder="Your Username" name="username" id="username" type="text" class="validate">
                                    <span class="helper-text red-text text-darken-2"><?= form_error('username') ?></span>
                                </div>
                                <div class="input-field  col s12">
                                    <i class="material-icons prefix">lock</i>
                                    <input required placeholder="Your Password" name="password" id="password" type="password" class="validate">
                                ...
                                <div class="col s7">
                                    <a href="<?= site_url('auth/register') ?>">Don't have an account?</a>
                                </div>
                            </form>
                        </div>
                    </div>
